...
return [
    ...
    'installed' => [
        'success_log_message' => 'Food Appi-Installationsprogramm erfolgreich INSTALLIERT am ',
        'update_log_message'  => 'Food Appi Installer erfolgreich AKTUALISIERT am ',
    ],
];